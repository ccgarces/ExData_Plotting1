...
#Plotting data to Plot4.png file.
png("plot4.png",width = 480, height = 480, units = "px")
par(mfrow=c(2,2))

with(data1, plot(Time, Global_active_power,  type = "n", ylab="Global Active Power", xlab=""))
lines( data1$Time, data1$Global_active_power)

with(data1, plot(Time, Voltage,  type = "n", ylab="Voltage", xlab="Time"))
...
with(data1, plot(Time, Global_reactive_power,  type = "n", xlab="datetime"))
